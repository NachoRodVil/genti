    ...
    <Container fluid style={{padding: 0}}>
      <Modal show={show} onHide={handleClose}>
          ...
          : (<>
            ...
            <h4 style={{fontWeight: "700", fontSize: "28px", marginLeft:"auto", marginTop:"5%", marginBottom:"5%", textAlign: "center"}} onClick={handleClose}>Voltar</h4>
            <p class="pModal" style={{textAlign: "center"}}>Tem dúvidas ou sugestões? Email pra Genti no <span style={{color:"#E5792A"}}>hello@genti.io</span> </p>
            </Modal.Body>
          </>)
          }
      ...
      <Row id="mainRow">
        <Col md={12} lg={5}>
          ...
          <button class="customButton" type="button" onClick={handleShow}>Testar a Genti</button>
        </Col>
      ...
      <Row id="mainRow" style={{padding:0, marginBottom: "5%"}}>
        <Col md={12} lg={7}>
      ...
      <div style={{marginTop: "18%"}}>
        ...
        <button class="customButton" type="button" style={{margin: "2.5% auto", display:"block"}} onClick={handleShow}>Testar a Genti</button>
